...
public class MainRESTController {
	...
	public ResponseEntity<ResponseDTO> deleteById(@PathVariable String tableName,@PathVariable int id){
		return new ResponseEntity<>(daoService.deleteById(tableName,id),HttpStatus.OK);
	}
