...
@Component
public class HardwarePlatformAssembler implements RepresentationModelAssembler<HardwarePlatform, EntityModel<HardwarePlatform>> {
    @Override
    ...
    @Override
    public CollectionModel<EntityModel<HardwarePlatform>> toCollectionModel(Iterable<? extends HardwarePlatform> hardwarePlatforms) {
        return CollectionModel.of(StreamSupport.stream(hardwarePlatforms.spliterator(), false)
                        .map(this::toModel)
